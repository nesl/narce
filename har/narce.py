...
from utils import set_seeds, CEDataset, StateCEDataset
...
parser.add_argument('nar_model', type=str, choices=['mamba2_v1', 'state_mamba2_v1'])
...
if args.train == 'pipeline' or args.train == 'adapter':
    ...
    run = wandb.init(
    # Set the project where this run will be logged
    project="state-narce-adapter" if has_state else "narce-adapter",
    name="adapter-falcon-{}-{}".format(args.sensor_dataset, args.seed),
    # Track hyperparameters and run metadata
    config={
